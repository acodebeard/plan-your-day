...
final class SettingsTest extends TestCase {
	...
	public function test_debug_api_counter_defaults_to_disabled(): void {
		self::assertFalse( Settings::defaults()['debug_api_counter_enabled'] );
	}

	public function test_sanitize_normalizes_debug_api_counter_toggle(): void {
		self::assertTrue(
			Settings::sanitize(
				[
