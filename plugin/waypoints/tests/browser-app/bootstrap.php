...
if ( ! defined( 'PLAN_YOUR_DAY_PLUGIN_URL' ) ) {
	define( 'PLAN_YOUR_DAY_PLUGIN_URL', trailingslashit( plan_your_day_browser_base_url() ) . 'plugin/waypoints/' );
}
...
function plan_your_day_browser_state_file(): string {
	...
	return dirname( __DIR__, 4 ) . '/tmp/waypoints-browser-state.json';
}
