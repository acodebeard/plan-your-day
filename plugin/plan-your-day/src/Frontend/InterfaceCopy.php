	...
	public static function groups(): array {
		return [
			...
			'search_results'  => [
				...
				'description' => __( 'Edit the search section heading and category search placeholder.', 'plan-your-day' ),
			],
			'trip'            => [
	...
	private static function trip_definitions(): array {
		return [
			...
			'waypoint_status_empty'               => [
				'label'       => __( 'Fixed waypoint status empty label', 'plan-your-day' ),
				'description' => __( 'Shown in the fixed bottom status button before any waypoints are selected.', 'plan-your-day' ),
				'group'       => 'trip',
				'type'        => 'text',
				'required'    => true,
				'default'     => __( 'Add some waypoints!', 'plan-your-day' ),
			],
			'waypoint_status_single'              => [
				'label'       => __( 'Fixed waypoint status single label', 'plan-your-day' ),
				'description' => __( 'Use {count} where the number of selected waypoints should appear.', 'plan-your-day' ),
				'group'       => 'trip',
				'type'        => 'text',
				'required'    => true,
				'default'     => __( '{count} waypoint added', 'plan-your-day' ),
			],
			'waypoint_status_plural'              => [
				'label'       => __( 'Fixed waypoint status plural label', 'plan-your-day' ),
				'description' => __( 'Use {count} where the number of selected waypoints should appear.', 'plan-your-day' ),
				'group'       => 'trip',
				'type'        => 'text',
				'required'    => true,
				'default'     => __( '{count} waypoints added', 'plan-your-day' ),
			],
