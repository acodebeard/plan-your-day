# Waypoints Plugin GitHub Issue Drafts
...
Summary: Create the initial plugin directory structure, main bootstrap file, plugin headers, namespace, constants, activation/deactivation hooks, and release metadata. The scaffold must use generic Waypoints naming and avoid destination-specific references.
